<template>
  <div class="entry-container mb-3 pointer p-2" @click="$router.push({name:'entry', params:{id:10}})">
    ...
    <div class="entry-description"> 
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nemo inventore optio sapiente a, numquam ex quisquam 
        ducimus impedit veniam ipsum beatae eum voluptates eligendi id possimus dolor. Magnam, et ex.
